...
| `defaultMode` | Default session mode for new interactive sessions (`interactive`, `plan`, `autopilot`) (v1.0.81+) |
| `defaultPermissionMode` | Default approval behavior for new interactive sessions, sets how the CLI handles permission requests by default (v1.0.81+) |
