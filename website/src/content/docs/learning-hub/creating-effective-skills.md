...
*(v1.0.72+)* You can also install skills via the plugins command, which supports local directories, URLs, and scope flags:

```bash
copilot plugins install --skill ./my-skill/                    # install from local directory
