...
You can open the GitHub Copilot app directly from your terminal with the `copilot app` command:

```bash
copilot app
```

This opens the Copilot app in the context of your current directory. If the current directory is a git repository with a GitHub remote, the app will automatically connect to that repository.
