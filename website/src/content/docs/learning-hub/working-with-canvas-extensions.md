...
description: 'Create and iterate on GitHub Copilot canvases using /create-canvas in the app or CLI, then shape them into reusable project or personal extensions.'
authors:
...
> **CLI support (v1.0.71+)**: Canvas extensions are now available in the GitHub Copilot CLI as well as the Copilot app. Use `/create-canvas` from an interactive CLI session to create extension-driven canvases directly from your terminal.
