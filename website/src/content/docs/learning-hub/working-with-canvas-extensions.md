...
> **CLI canvas support (v1.0.71+)**: Canvas extensions are now also supported in the GitHub Copilot CLI, not just the app. Extension-driven canvas interactions work in CLI sessions, so canvases you build can be used across both surfaces.
