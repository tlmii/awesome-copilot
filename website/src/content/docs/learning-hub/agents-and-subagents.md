...
> **Updated default in v1.0.71**: The default maximum subagent nesting depth was lowered from 6 to 4 to reduce runaway recursive delegation. Usage-based billing users can raise it up to 128 by adjusting `subagents.maxDepth` in `/settings`.
